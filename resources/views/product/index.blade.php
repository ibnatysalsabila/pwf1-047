                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                                @forelse ($products as $product)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-100">
                                        ...
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">{{ $product->quantity }}</td>
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                @can('manage-product')
                                                    ...
                                                    <form action="{{ route('product.delete', $product) }}" method="POST" onsubmit="return confirm('Hapus produk ini?')">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
