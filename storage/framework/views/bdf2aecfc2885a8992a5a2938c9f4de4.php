                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-100">
                                        ...
                                        <td class="px-6 py-4 font-medium text-gray-800 dark:text-gray-100"><?php echo e($product->name); ?></td>
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">
                                            <?php echo e($product->category->name ?? '-'); ?>

                                        </td>
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300"><?php echo e($product->quantity); ?></td>
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <a href="<?php echo e(route('product.show', $product)); ?>"
                                                    class="p-1.5 rounded-md text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition" title="View">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-product')): ?>
                                                    ...
                                                    <form action="<?php echo e(route('product.delete', $product)); ?>" method="POST" onsubmit="return confirm('Hapus produk ini?')">
                                                        <?php echo csrf_field(); ?>
