                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition duration-100">
                                        ...
                                        <td class="px-6 py-4 text-gray-600 dark:text-gray-300">
                                            <span
                                                ...
                                                <?php echo e($product->qty > 10 ? 'bg-green-100 text-green-800 dark:bg-green-900/40 dark:text-green-300' : 'bg-red-100 text-red-700 dark:bg-red-900/40 dark:text-red-300'); ?>">
                                        ...
                                        <td class="px-6 py-4">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <a href="<?php echo e(route('product.show', $product->id)); ?>" class="p-1.5 rounded-md text-gray-400 hover:text-indigo-600 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 transition" title="View">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <a href="<?php echo e(route('product.edit', $product)); ?>" class="p-1.5 rounded-md text-gray-400 hover:text-amber-600 hover:bg-amber-50 dark:hover:bg-amber-900/30 transition" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <form action="<?php echo e(route('product.delete', $product->id)); ?>" method="POST" onsubmit="return confirm('Delete this product?')">
                                                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\pwf1-047\resources\views/product/index.blade.php ENDPATH**/ ?>