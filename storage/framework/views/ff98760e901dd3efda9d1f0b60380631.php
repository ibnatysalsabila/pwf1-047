        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="<?php echo e(route('category.store')); ?>" method="POST" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        <div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\pwf1-047\resources\views/category/create.blade.php ENDPATH**/ ?>